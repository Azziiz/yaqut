...
export default async function Order() {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-20">
        <h1 className="text-3xl text-center font-semibold text-[#B1275B]">Order Page</h1>
        <table className="w-full border-collapse">
            ...
            <tbody>
                {orders.map(product => (
                    <tr key={product._id} className=" hover:bg-gray-50 text-center border-b border-gray-300 text-[#B1275B] ">
