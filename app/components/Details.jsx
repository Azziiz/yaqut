    ...
    <div className=" max-w-7xl mx-auto mt-20">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col p-6 justify-between">
          <h1 className="text-3xl font-semibold text-[#A394FF]">{product?.name}</h1>
          <p className="text-lg mt-4 text-gray-500">{product?.description}</p>

          <div className="mt-5">
            <span className="text-2xl font-semibold text-[#A394FF]">{product?.price}</span>
          </div>
          ...
          <div className="mt-6">
            <button onClick={handleAddToCart} className="bg-[#A394FF] text-white py-3 px-6 rounded-md">Add to Cart</button>
          </div>
